...
distorted one, and does so identically regardless of provenance. The
theta_real in the certificate is the same across sources; only theta_synth
...
class TestCertifyDataset:
    def test_faithful_source_certifies(self):
        ...
        # Portable: the certificate carries theta_real +/- SE for re-checking.
...
class TestCertifyMany:
    def test_same_theta_real_discriminates_across_sources(self):
        ...
        # theta_real is a property of the real data — identical across sources.
