...
Engine boundary: the API orchestrates the engine but does
...
def _run_one_pass(
    ...
    seed) — same inputs → identical batch (Invariant 2).
...
def generate(
    ...
    Three operating points (design notes):
...
def draft_scenario(
    ...
    *,
    ...
    try:
        ...
        # never silently guess a load-bearing target (decision-support).
